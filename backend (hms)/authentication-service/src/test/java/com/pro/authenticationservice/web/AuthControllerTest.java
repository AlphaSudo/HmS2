...
class AuthControllerTest {
    ...
    void loginShouldReturnTokenWhenCredentialsValid() throws Exception {
        var req = new LoginRequest("user", "pass", "PATIENT");
        var jwtResp = new JwtResponse("jwt-token", "Bearer", 1L, "user", List.of("ROLE_PATIENT"));
    ...
    void loginShouldReturnUnauthorizedWhenCredentialsInvalid() throws Exception {
        var req = new LoginRequest("user", "wrong", "PATIENT");
