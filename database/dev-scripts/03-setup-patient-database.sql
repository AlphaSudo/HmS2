...
-- Patient ID 1: user_id 8 (john.doe)
...
-- Patient ID 2: user_id 9 (jane.smith)
...
-- Patient ID 3: user_id 10 (mike.wilson)
...
-- Patient ID 4: user_id 11 (sarah.johnson)
...
-- Patient ID 5: user_id 12 (david.brown)
...
-- Patient ID 6: user_id 13 (emily.davis)
...
-- Patient ID 7: user_id 14 (robert.clark)
...
-- Patient ID 8: user_id 15 (lisa.martinez)
...
-- Display summary
SELECT 
    'Patients Database Setup Complete' as status,
...
-- Show patients by assigned doctor
SELECT 
    doctor_assigned,
    doctor_id,
    COUNT(*) as patient_count
FROM patients
GROUP BY doctor_assigned, doctor_id
ORDER BY doctor_id;
