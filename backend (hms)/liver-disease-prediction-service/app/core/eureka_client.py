    ...
    def register(self):
        ...
        registration_data = {
            "instance": {
                ...
                "statusPageUrl": f"http://{self.service_host}:{self.service_port}/liver-disease-prediction/health",
                "healthCheckUrl": f"http://{self.service_host}:{self.service_port}/liver-disease-prediction/health",
